...
<alert xmlns="urn:oasis:names:tc:emergency:cap:1.2">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-xl animate-fadeIn">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl bg-[#0a0a0a] border border-rose-500/50 shadow-[0_0_80px_rgba(239,68,68,0.25)]">
        {/* Modal Header */}
        <div className="flex items-center justify-between p-5 border-b border-rose-500/30 bg-gradient-to-r from-rose-950/40 via-[#111111] to-[#0a0a0a]">
          ...
          <button
            onClick={handleClose}
            className="p-2 rounded-lg text-[#71717A] hover:text-white hover:bg-[#161616] transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Tab Switcher */}
        <div className="flex items-center border-b border-[#1c1c1c] bg-[#0c0c0c] px-6 pt-2 gap-4 text-xs font-mono">
          <button

...
export default function AboutPage({ setActivePage }) {
  ...
  const technologies = [
    ...
    },
    {
      ...
      desc: 'Integration with IMD Doppler radar grids, satellite precipitation estimates, and automated tipping bucket rain gauges.',
      icon: CloudRain,
      color: 'text-blue-400',
  ...
  const pitchSlides = [
    ...
    },
    {
      ...
      metric: 'Generates up to 3.4 hours of early evacuation lead time.',
      badge: 'SOLUTION'
    },
    {
  ...
  const handleNextSlide = () => {
    soundManager.playBeep(850, 0.08);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-10">
      {/* Top Header */}
      <div className="border-b border-slate-800 pb-6 text-left flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-base sm:text-lg text-cyan-300 font-mono mt-2">
      ...
      <div className="p-8 rounded-3xl glass-panel-glow border border-cyan-500/30 space-y-4 text-left">
        ...
        <p className="text-base text-slate-200 leading-relaxed max-w-4xl">
          <strong className="text-cyan-400">LandslideGuard AI</strong> is an intelligent disaster management platform that combines environmental monitoring, artificial intelligence, GIS mapping, and community reporting to provide early warnings for potential landslides in mountainous and high-risk regions.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {technologies.map((tech, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-6 rounded-2xl glass-panel border border-slate-800 hover:border-slate-700 transition-all space-y-3"
              >
      ...
      <div className="p-8 rounded-3xl glass-panel border border-slate-800 space-y-6 text-left">
        <div>
          <span className="text-xs font-mono text-cyan-400 uppercase font-bold tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs font-mono">
          ...
          <div className="p-4 rounded-xl bg-slate-900/90 border border-rose-500/40 bg-rose-950/20 space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
        <div className="p-6 rounded-2xl glass-panel border border-slate-800 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-base font-bold text-white">National Disaster Management Authority (NDMA)</h4>
          </div>
        ...
        <div className="p-6 rounded-2xl glass-panel border border-slate-800 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-base font-bold text-white">UN Sendai Framework Target G</h4>
          </div>
          <p className="text-xs text-slate-300 leading-relaxed">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fadeIn">
          <div className="relative w-full max-w-3xl overflow-hidden rounded-3xl glass-panel border border-cyan-500/50 p-6 space-y-6 shadow-[0_0_60px_rgba(6,182,212,0.3)]">
            ...
            <div className="space-y-4 text-left py-4 min-h-[220px]">
              ...
              <div className="p-3.5 rounded-xl bg-slate-900/90 border border-slate-800 text-xs font-mono text-emerald-400 font-bold">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-800">
                ...
                {pitchSlides.map((_, i) => (
                  <div
                    ...
                    className={`h-2 rounded-full transition-all cursor-pointer ${
                      currentSlide === i ? 'w-8 bg-cyan-400' : 'w-2 bg-slate-800 hover:bg-slate-700'
                    }`}
                  />
                ))}
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs disabled:opacity-30 cursor-pointer"
                >
                  <span>Next</span>
